...
public class recent_pictures_adapter extends RecyclerView.Adapter<recent_pictures_adapter.MyViewHolder> {

    private Context mContext;
    private List<recent_pictures_list> recentPicturesList;
    private List<recent_pictures_list> recentPicturesListFiltered;

    String DogStatus;
    View itemView;
    recent_pictures_list row, row1;

    public recent_pictures_adapter(Context context, List<recent_pictures_list> recentPicturesList) {
        super();
        // this.parentActivity = parentActivity;
        this.mContext = context;
        this.recentPicturesListFiltered = recentPicturesList;
        this.recentPicturesList = recentPicturesList;
    }

    @Override
    public int getItemCount() {

        return recentPicturesList.size();
    }

    @Override
    public recent_pictures_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_view5, parent, false);
        final recent_pictures_adapter.MyViewHolder viewHolder = new recent_pictures_adapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final recent_pictures_adapter.MyViewHolder holder, final int i) {
        row = recentPicturesList.get(i);
        ...
        holder.Ll_video.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Integer.parseInt(StBalance)>0) {
                    ...
                    editor.putString("recommended_pictures_url","resend-articals");
...
//        holder.Rl_recent_pictures_list.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//
//                row1 = recentPicturesList.get(i);
