...
public class video_list_adapter extends RecyclerView.Adapter<video_list_adapter.MyViewHolder> {
    ...
    public video_list_adapter(Context context, List<video_list> videoList) {
        super();
    ...
    public video_list_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final video_list_adapter.MyViewHolder viewHolder = new video_list_adapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final video_list_adapter.MyViewHolder holder, final int i) {
        row = videoList.get(i);
