...
public class article_list_adapter extends RecyclerView.Adapter<article_list_adapter.MyViewHolder> {
    ...
    public article_list_adapter(Context context, List<article_list> articleList) {
        super();
    ...
    @Override
    public article_list_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_view3, parent, false);
        final article_list_adapter.MyViewHolder viewHolder = new article_list_adapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final article_list_adapter.MyViewHolder holder, final int i) {
