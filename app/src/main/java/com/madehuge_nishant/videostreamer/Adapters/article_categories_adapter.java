...
import com.madehuge_nishant.videostreamer.Picture_by_cat;
import com.madehuge_nishant.videostreamer.R;

import java.util.List;

public class article_categories_adapter  extends RecyclerView.Adapter<article_categories_adapter.MyViewHolder> {
    ...
    public article_categories_adapter(Context context, List<category_list> commentsList) {
        super();
    ...
    @Override
    public article_categories_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.categories_view, parent, false);
        final article_categories_adapter.MyViewHolder viewHolder = new article_categories_adapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final article_categories_adapter.MyViewHolder holder, final int i) {
...
//                    Toast.makeText(mContext, StCatid, Toast.LENGTH_SHORT).show();
                Intent in =new Intent(mContext,Picture_by_cat.class);
