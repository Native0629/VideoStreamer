...
public class top_videos_adapter extends RecyclerView.Adapter<top_videos_adapter.MyViewHolder> {
    ...
    public top_videos_adapter(Context context, List<video_list> videoList) {
        super();
    ...
    @Override
    public top_videos_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_view, parent, false);
        final top_videos_adapter.MyViewHolder viewHolder = new top_videos_adapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final top_videos_adapter.MyViewHolder holder, final int i) {
        row = videoList.get(i);
