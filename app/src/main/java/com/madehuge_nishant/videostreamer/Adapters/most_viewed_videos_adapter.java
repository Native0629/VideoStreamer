...
public class most_viewed_videos_adapter extends RecyclerView.Adapter<most_viewed_videos_adapter.MyViewHolder> {

    private Context mContext;
    private List<most_viewed_videos_list> mostViewedvideosList;
    private List<most_viewed_videos_list> mostViewedvideosListFiltered;

    String DogStatus;
    View itemView;
    most_viewed_videos_list row, row1;

    public most_viewed_videos_adapter(Context context, List<most_viewed_videos_list> mostViewedvideosList) {
        super();
        // this.parentActivity = parentActivity;
        this.mContext = context;
        this.mostViewedvideosListFiltered = mostViewedvideosList;
        this.mostViewedvideosList = mostViewedvideosList;
    }

    @Override
    public int getItemCount() {

        return mostViewedvideosList.size();
    }

    @Override
    public most_viewed_videos_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_view4, parent, false);
        final most_viewed_videos_adapter.MyViewHolder viewHolder = new most_viewed_videos_adapter.MyViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final most_viewed_videos_adapter.MyViewHolder holder, final int i) {
        row = mostViewedvideosList.get(i);
...
//                .into(holder.IvVideo);
        ...
        holder.Ll_video.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                row1 = mostViewedvideosList.get(i);
                if (Integer.parseInt(StBalance) > 0) {
                    ...
                    editor.putString("recommended_video_url", "most-viewed-videos");
                    editor.commit();
...
//        holder.Rl_most_viewed_videos_list.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//
//                row1 = mostViewedvideosList.get(i);
